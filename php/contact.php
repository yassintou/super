    ...
    <div class="inside">
        ...
        <div class="prclass">
            ...
            <span class="first">
                ...
                <span>              <h3>Numero</h3>
                                    <input class="padding" type="text" placeholder="+212609071094" name="numero">
                </span>
            </span>
            <span class="third">
                <h3>Message</h3>
            <input class="pad" type="text" placeholder="Envoyer votre message ici..." name="message">
            </span>
...
if ($mysqli->connect_error){
    die('Erreur de connexion a la base de donnees'. $mysqli->connect_error);
            ...
            $stm->bind_param('sssss',$nom,$prenom,$numero,$email,$message);
            if($stm->execute()) {
